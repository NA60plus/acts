...
void addDigitization(Context& ctx) {
...

  {
    ...
    ACTS_PYTHON_MEMBER(outputClustersVT);
    ACTS_PYTHON_MEMBER(outputMeasurementParticlesMapVT);
    ACTS_PYTHON_MEMBER(outputMeasurementSimHitsMapVT);
    ACTS_PYTHON_MEMBER(outputClustersMS);
    ACTS_PYTHON_MEMBER(outputMeasurementParticlesMapMS);
    ACTS_PYTHON_MEMBER(outputMeasurementSimHitsMapMS);
