...
class MatchingPlotTool {
 public:
  ...
  MatchingPlotTool(const Config& cfg, Acts::Logging::Level lvl);

  /// @brief book the efficiency plots
  ///
  /// @param MatchingPlotCache the cache for efficiency plots
  void book(MatchingPlotCache& MatchingPlotCache) const;

  /// @brief fill efficiency plots
  ///
  /// @param MatchingPlotCache cache object for efficiency plots
  /// @param truthParticle the truth Particle
  /// @param status the reconstruction status
  void fill(MatchingPlotTool::MatchingPlotCache& MatchingPlotCache, double zrec, double zgen) const;

  /// @brief write the efficiency plots to file
  ///
  /// @param MatchingPlotCache cache object for efficiency plots
  void write(const MatchingPlotCache& MatchingPlotCache) const;

  /// @brief delete the efficiency plots
  ///
  /// @param MatchingPlotCache cache object for efficiency plots
  void clear(MatchingPlotCache& MatchingPlotCache) const;
